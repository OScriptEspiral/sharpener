...
from .views import (create_exercises_blueprint, create_topics_blueprint,
                    ...
                    create_classes_blueprint, create_tracks_blueprint,
                    create_enrollments_blueprint)


def create_app(db_session, github_config, flask_secret, bucket_submissions,
               debug=True):
    ...
    submissions = create_submissions_blueprint(db_session, request,
                                               bucket_submissions)
